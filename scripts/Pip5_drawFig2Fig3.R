...
p_2
ggsave(filename = "onputs/Fig2_ALPSdiffcor.png", width = 7, height = 4)
ggsave(filename = "onputs/Fig2_ALPSdiffcor.tiff", width = 7, height = 4)
...
p_3
ggsave(filename = "onputs/Fig3_ALPSmodulation.png", width = 6, height = 6)
ggsave(filename = "onputs/Fig3_ALPSmodulation.tiff", width = 6, height = 6)
